...
cp -r github/github-pr-workflow ~/.hermes/skills/github/github-pr-workflow/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/github-pr-workflow-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/github-pr-workflow-skill.git ~/.hermes/skills/github/github-pr-workflow/
```
...
```text
skill_view(name="github/github-pr-workflow")
```
...
```text
Use the github pr workflow skill to <describe your specific task here>
```
...
```text
Gunakan skill github pr workflow untuk <deskripsikan tugas spesifik Anda di sini>
```
